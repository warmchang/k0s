...
require (
	...
	sigs.k8s.io/controller-runtime v0.15.1 // includes https://github.com/kubernetes-sigs/controller-runtime/pull/2223
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.27.4/go.mod#L245-L275
